...
import { Product, Platform, Connection } from '../types';
              ...
              return (
                  <div className="space-y-6 animate-in slide-in-from-right-8 duration-300">
                      <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 p-5 lg:p-8 rounded-[2rem] border border-emerald-100/50 dark:border-emerald-800/50 shadow-sm relative overflow-hidden">
                          ...
                          <button 
                              className={`w-full mt-6 py-3.5 sm:py-4 rounded-xl font-bold text-base sm:text-lg shadow-lg transition-all active:scale-[0.98] flex items-center justify-center gap-3 relative z-10 ${
            ...
            <div className="hidden md:flex items-center gap-2 overflow-x-auto scrollbar-hide pb-1" ref={navRef}>
                {WIZARD_STEPS.map((step, idx) => (
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-all text-sm font-medium whitespace-nowrap border ${
